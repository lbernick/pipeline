...
func readRuntimeObjectAsPipeline(ctx context.Context, obj runtime.Object, k8s kubernetes.Interface, refSource *v1beta1.RefSource, verificationPolicies []*v1alpha1.VerificationPolicy) (*v1beta1.Pipeline, error) {
	...
	case *v1beta1.Pipeline:
		...
		verificationErr := trustedresources.VerifyPipeline(ctx, obj, k8s, refSource, verificationPolicies)
		if verificationErr != nil {
			return nil, fmt.Errorf("remote Pipeline verification failed for object %s: %w", obj.GetName(), verificationErr)
		}
		obj.SetDefaults(ctx)
		...
		if validationErr != nil {
			return nil, fmt.Errorf("remote Pipeline validation failed for object %s: %w", obj.GetName(), validationErr)
		}
		return obj, nil
	case *v1.Pipeline:
		obj.SetDefaults(ctx)
