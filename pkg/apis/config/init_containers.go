...
// GetInitContainerConfigName returns the name of the configmap containing all
// feature flags.
func GetInitContainerConfigName() string {
	if e := os.Getenv("CONFIG_INIT_CONTAINERS_NAME"); e != "" {
		return e
	}
