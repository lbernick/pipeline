...
const (
	...
	TaskRunCancelledByPipelineMsg TaskRunSpecStatusMessage = "Cancelled because the parent PipelineRun has been cancelled."
	...
	TaskRunCancelledByPipelineTimeoutMsg TaskRunSpecStatusMessage = "Cancelled because the parent PipelineRun has timed out."
)
