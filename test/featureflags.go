...
// Integration tests are run once each with "enable-api-fields" set to "alpha", "beta", and "stable".
// requireAlphaFeatureFlags skips tests if "enable-api-fields" is not set to "alpha",
// and likewise for requireBetaFeatureFlags.
var requireAlphaFeatureFlags = requireAllGates(map[string]string{
	"enable-api-fields": "alpha",
})
var requireBetaFeatureFlags = requireAllGates(map[string]string{
