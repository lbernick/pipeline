...
instructs Tekton to retry executing the `Task` when this happens. `retries` are skipped
when other `Task`s in the `Pipeline` have failed, or if the `PipelineRun` has
been [cancelled](./pipelineruns.md#cancelling-a-pipelinerun),
[gracefully cancelled](./pipelineruns.md#gracefully-cancelling-a-pipelinerun), or
[gracefully stopped](./pipelineruns.md#gracefully-stopping-a-pipelinerun).
